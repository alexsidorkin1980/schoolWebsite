    ...
    <div class="row">
      ...
      <div class="posts col-8">
        ...
        <div class="row add-post">
          ...
          <form action="book-out-teach.php?id=<?php echo $_GET['id']; ?>" method='post'>
            <div class="col">
              <label for="formGroupExampleInput" class="form-label">ФИО</label>
              <?php combobox('teachers'); ?>
            </div>
            <div class="col">
              <label for="formGroupExampleInput" class="form-label">Предполагаемая дата возврата книги</label>
              <input name="return_date" value="" type="date" class="form-control" id="formGroupExampleInput"
                placeholder="Введите дату возврата книги...">
            </div>
            <div class="w-100"></div>
            <div class="col">
              <button class="btn btn-primary" name="book-out-teach" type="submit">Выдать</button>
            </div>
          </form>
        </div>
      </div>
