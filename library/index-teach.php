...
$classes = selectAll('library_teach', ['status' => 'available']);
?>
                     ...
                     <div id="task-collapse-<?php echo $oneTask['id']; ?>" class="accordion-collapse collapse row"
                        ...
                        <div class="accordion-body">
                           ...
                           <div class="d-flex justify-content-start action-task">
                              <a href="/library/book-out-teach.php?id=<?php echo $oneTask['id']; ?>"
                                 class="btn btn-primary me-2">Выдать</a>
                              <a href="/library/edit-book-teach.php?id_book_teach=<?php echo $oneTask['id']; ?>"
                                 class="btn btn-primary me-2">Edit</a>
                              <a href="index-teach.php?book_teach_delete=<?php echo $oneTask['id']; ?>"
