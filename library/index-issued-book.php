...
$classes = selectAll('library', ['class' => $class, 'status' => 'issued']);
?>
         ...
         <div class=" col-md-8">
            ...
            <div class="accordion" id="tasks-accordion">
               ...
               foreach ($classes as $key => $oneTask):
                  $student = selectOne('students', ['id' => $oneTask['id_student']]);
                  $class = selectOne('classes', ['id' => $student['class_id']]);
                  ?>
                  <div class="accordion-item mb-2">
                     ...
                     <div class="accordion-header d-flex justify-content-between align-items-center row"
                        ...
                        <h2 class="accordion-header col-12 col-md-12">
                           <button name='button<?php echo $oneTask['id']; ?>'
                              style="background-color: <? //=$priorityColor  ?>;" class="accordion-button collapsed"
                        ...
                        <div class="accordion-body">
                           ...
                           <p class="row">
                              <span class="col-12 col-md-6"><strong><i class="fa-solid fa-person-circle-question"></i> Дата
                                    издания:</strong>
                                 <?= isset($oneTask['date_edition']) ? htmlspecialchars($oneTask['date_edition']) : ''; ?>
                              </span>
                              <span class="col-12 col-md-6"><strong><i class="fa-solid fa-hourglass-start"></i> Дата
                                    выдачи:</strong>
                                 <?= isset($oneTask['borrow_date']) ? htmlspecialchars($oneTask['borrow_date']) : ''; ?>?>
                              </span>
                           </p>
                           ...
                           <p class="row">
                              <span class="col-12 col-md-6"><strong><i class="fa-solid fa-person-circle-question"></i> Дата
                                    возврата:</strong>
                                 <?= isset($oneTask['return_date']) ? htmlspecialchars($oneTask['return_date']) : ''; ?>
                              </span>
                              <span class="col-12 col-md-6"><strong><i class="fa-solid fa-hourglass-start"></i> У
                                    кого:</strong>
                                 <?php echo htmlspecialchars($student['name']); ?>
                                 <?php echo htmlspecialchars(' ' . $class['number'] . '-' . $class['letter']); ?>
                              </span>
                           </p>
                           <hr>

                           <div class="d-flex justify-content-start action-task">
                              <a href="/library/index-issued-book.php?id_book_return_st=<?php echo $oneTask['id']; ?>&class=<?php echo $oneTask['class']; ?>"
