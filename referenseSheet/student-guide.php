...
<body>
  ...
  $num_class = isset($_POST['Combobox1']) ? $_POST['Combobox1'] : null;
  // // exit();
    ...
    <div class="content row">
      ...
      <div class="main-content col-md-9 col-12">
        ...
        <div class="table-content">
          ...
          <div style="z-index:1;margin-left:100px;">
            <?= $look ?>
          </div>
              ...
              foreach ($sp as $item) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a type="button" class="but" data-bs-toggle="modal" data-bs-target="#exampleModal"><b>
                          <?= $pip; ?>
                        </b></a></td>
                    <td>
                      <?= $dn; ?>
