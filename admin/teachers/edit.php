...
<?php require_once '../../app/helps/errorInfo.php'; ?>
 ...
 <div class="col">
        ...
        <input name="name" value="<?=$name;?>" readonly type="text" class="form-control" id="formGroupExampleInput" placeholder="Введите фамилию имя отчество...">
    ...
    <div class="w-100"></div>
      ...
      <input name="email" value="<?=$email;?>" readonly type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"placeholder="Введите вашу почту...">
