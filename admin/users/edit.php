...
<body>
      ...
      <div class="row add-post">
        ...
        <form action="edit.php" method='post'>
          ...
          <div class="col">
            ...
            <input name="email" readonly value="<?= $mail; ?>" type="email" class="form-control" id="exampleInputEmail1"
          ...
          <div class="form-check">
            <input name='librarian' class="form-check-input" type="checkbox" value="2" id="flexCheckChecked">
            <label class="form-check-label" for="flexCheckChecked">
              Librarian?
            </label>
          </div>
 -->
          ...
          <div class="col">
            <button class="btn btn-primary" name="edit-user" type="submit">Обновление</button>
          </div>
        </form>
      </div>
    </div>
